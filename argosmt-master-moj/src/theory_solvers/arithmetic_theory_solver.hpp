...
private:
  ...
  void assert_upper(const expression & l, int local_search = 0);
  void assert_lower(const expression & l, int local_search = 0);
  void assert_both(const expression & l, int local_search = 0);
  void assert_split(const expression & l, int local_search = 0);
  ...
  void propagate_bound_refinements(int local_search = 0);
  void propagate_weaker_constraints(const expression & unknown, const constraint & c, int local_search = 0);
  ...
  void check_equalities(int local_search = 0);
...
public:
  ...
  virtual void check_and_propagate(unsigned layer, unsigned local_search);
